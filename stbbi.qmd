...
The pay-it-forward (PIF) model represents more than just an access intervention—it is a **social innovation strategy** designed to reimagine how STI services are delivered and experienced. When combined with community engagement, PIF helps foster environments where testing is **accessible**, **stigma-sensitive**, and **rooted in mutual support**.

Community engagement in this context refers to voluntary, health-promoting actions—such as peer outreach, advocacy, and public health participation—that reinforce the goals of PIF. Together, these approaches seek to:
...
This work contributes to reimagining how public health systems can deliver STI testing in ways that are equitable, effective, and empowering. Key public health contributions include:
