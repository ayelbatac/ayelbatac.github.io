...
<div style="width: 100vw; margin-left: calc(-50vw + 50%); padding: 3rem 2rem; background-color: #ffffff;">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 2rem;">
    ...
    <!-- Blog Tile -->
    <a href="guidelines-global-access-structural-gaps-anaphylaxis-treatment.qmd" style="flex: 1; min-width: 280px; max-width: 300px; text-decoration: none; color: inherit; display: flex; flex-direction: column;">
