---
title: "Diagnostics Research | Ayel L. R. Batac"
title-block: false
canonical-url: https://ayelbatac.github.io/diagnostics
description: "Research on diagnostic innovation by Ayel L. R. Batac, focusing on self-testing technologies, infectious disease detection, and expanding equitable access to diagnostics."
...
In sexually transmitted infections (STI), delayed or missed diagnoses remain a major driver of ongoing transmission and adverse health outcomes. Syphilis, for example, has resurged globally despite the availability of effective testing and curative treatment. Early symptoms are often mild or absent, and barriers such as stigma, inconvenient clinic hours, travel distance, and financial costs can discourage individuals from accessing facility-based testing services.
...
<div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: flex-start; margin-top: 1.5rem;">
  ...
  <div style="flex: 1; min-width: 250px;">
    ...
    <h3 style="font-weight: 600; color: #1B153E; margin: 0 0 1rem 0; font-size: 1.05rem;">
        <a href="https://doi.org/10.1128/jcm.00982-25"
        target="_blank"
...
<small>
This work is conducted in my capacity as a researcher at the London School of Hygiene and Tropical Medicine and reflects collaboration with academic, clinical, and public health partners to advance equitable and evidence-informed approaches to diagnostic innovation and implementation.
</small>
